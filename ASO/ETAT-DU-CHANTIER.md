...
- `scripts/screenshots.sh` : captures auto (simulateurs dédiés « ASC iPhone 6.9 » / « ASC iPad 13 » créés par le script, barre d'état 9:41, 6 écrans en-US : accueil, mesure, découverte, détails, 3D, traces ; les autres locales du TSV ont encore les 3 anciens écrans). Formats : iPhone 6,9" portrait, iPad 13" portrait **et paysage** (`ipad13-landscape`, rotation par `scripts/SimRotator`), Mac 16:10.
