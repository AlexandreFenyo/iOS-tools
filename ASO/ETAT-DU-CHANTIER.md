...
- **Mode démo captures** : `DemoData.swift`, arguments `-UIScreenshotMode` + `-UIScreenshotScenario welcome|heatmap|measure|discover|3d|traces`, navigation auto, données fictives (sondes, courbe de latence, journal), aucune dépendance réseau.
