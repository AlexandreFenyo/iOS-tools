...
class SpeedTestChargenClient : SpeedTestClient {
    ...
    public override init(input_stream: InputStream, output_stream: OutputStream, from: LocalChargenDelegate) {
...
class LocalChargenDelegate : LocalDelegate<SpeedTestChargenClient> {
