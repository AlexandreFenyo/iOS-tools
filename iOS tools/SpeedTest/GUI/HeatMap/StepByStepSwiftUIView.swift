    ...
    var body: some View {
        VStack {
            ...
            NavigationStack(path: $navigation_path) {
                StepWelcomeView(showing_exit_button: $showing_exit_button, showing_exit_popup: $showing_exit_popup, scale: $scale, navigation_path: $navigation_path, step_by_step_view_controller: step_by_step_view_controller)
            }
            .background(Color(COLORS.right_pannel_scroll_bg))
            .cornerRadius(15)
                    ...
                    case .step_choose_plan:
                        VStack {
                            ...
                            OrientationView { is_portrait, size in
                                StepChoosePlan(navigation_path: $navigation_path, step_by_step_view_controller: step_by_step_view_controller, is_portrait: is_portrait, size: size)
                                    .onAppear {
